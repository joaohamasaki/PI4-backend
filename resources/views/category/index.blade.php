    ...
    <main>
        ...
        <section class="container mt-5">
            ...
            <div class="align-self-center mt-3">
                <a href="{{route ('category.create')}}" class="btn btn-md btn-success">Crie sua Categoria</a>
            </div>
            <div class="row mt-3">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$cat->id}}</td>
                            <td>{{$cat->name}} ({{$cat->rooms->count()}})</td>
                            <td>
                                <a href="#" class="btn btn-sm btn-info">Visualizar</a>
                                <a href="{{route('category.edit', $cat->id)}}" class="btn btn-sm btn-primary">Editar</a>
